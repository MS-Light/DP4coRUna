...
class LoggerViewController: UIViewController {
    ...
    func loadItems(){
        if let data = try? Data(contentsOf: dataFilePath!){
            ...
            LoggerSettings.gpsEnabled = itemArray[2].switchedON
            LoggerSettings.compassEnabled = itemArray[3].switchedON
            LoggerSettings.altimeterEnabled = itemArray[4].switchedON
            LoggerSettings.pedometerEnabled = itemArray[5].switchedON
            LoggerSettings.accelerometerEnabled = itemArray[6].switchedON
            LoggerSettings.gyroscopeEnabled = itemArray[7].switchedON
            LoggerSettings.proximityEnabled = itemArray[8].switchedON
    ...
    @IBAction func detectorButtonTouched(_ sender: UIButton) {
        performSegue(withIdentifier: K.detector, sender: self)
    }

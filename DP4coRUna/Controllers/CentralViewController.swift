...
extension CentralViewController{
    ...
    private func sendData() {
        ...
        if CentralViewController.sendingEOM {
            // send it
            let didSend = peripheralManager.updateValue("EOM".data(using: .utf8)!, for: transferCharacteristic, onSubscribedCentrals: nil)
            // Did it send?
            if didSend {
                // It did, so mark it as sent
                CentralViewController.sendingEOM = false
                os_log("Sent: EOM")
            }
        ...
        while didSend {
            ...
            if sendDataIndex >= dataToSend.count {
                ...
                CentralViewController.sendingEOM = true
...
extension CentralViewController: CBPeripheralManagerDelegate {
    ...
    func peripheralManager(_ peripheral: CBPeripheralManager, central: CBCentral, didSubscribeTo characteristic: CBCharacteristic) {
        ...
        // Get the data
        dataToSend = text2!.data(using: .utf8)!
